...
const About = () => {
  return(
    <div className="ui segment-1">
      ...
      Duis pharetra mauris id varius mattis. Vestibulum pellentesque mi a orci aliquet, non interdum dui gravida. Nunc nec semper tellus.Curabitur a interdum magna.
      </p>
    </div>
  )
}
